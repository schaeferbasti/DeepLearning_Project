...
class CNN_Auto_Basic_Big:
    ...
    def build_model(self):
        ...
        decoder_cnn1 = Conv1D(512, kernel_size=5, padding='same', activation='relu')(dec_emb)
        decoder_cnn2 = Conv1D(256, kernel_size=5, padding='same', activation='relu')(decoder_cnn1)
        decoder_cnn3 = Conv1D(128, kernel_size=5, padding='same', activation='relu')(decoder_cnn2)
        decoder_cnn4 = Conv1D(64, kernel_size=3, padding='same', activation='relu')(decoder_cnn3)
        decoder_cnn5 = Conv1D(32, kernel_size=3, padding='same', activation='relu')(decoder_cnn4)
        #decoder_cnn6 = Conv1D(16, kernel_size=3, padding='same', activation='relu')(decoder_cnn5)
        ...
        decoder_outputs = decoder_dense(decoder_cnn5)
