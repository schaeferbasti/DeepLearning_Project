...
class CNN_Auto_Complex_Big:
    ...
    def build_model(self):
        ...
        dec_conv_1 = Conv1DTranspose(16, 3, strides=1, padding='same')(enc_conv_7)
        dec_activ_1 = Activation('softmax')(dec_conv_1)
        dec_conv_2 = Conv1DTranspose(32, 3, strides=1, padding='same')(dec_activ_1)
        dec_activ_2 = Activation('softmax')(dec_conv_2)
        dec_conv_3 = Conv1DTranspose(64, 3, strides=1, padding='same')(dec_activ_2)
        dec_activ_3 = Activation('softmax')(dec_conv_3)
        dec_conv_4 = Conv1DTranspose(128, 5, strides=1, padding='same')(dec_activ_3)
        dec_activ_4 = Activation('softmax')(dec_conv_4)
        dec_conv_5 = Conv1DTranspose(256, 5, strides=1, padding='same')(dec_activ_4)
        dec_activ_5 = Activation('softmax')(dec_conv_5)
        dec_conv_6 = Conv1DTranspose(512, 5, strides=1, padding='same')(dec_activ_5)
        dec_activ_6 = Activation('softmax')(dec_conv_6)
