...
class CNN_Auto_Complex_Big:
    ...
    def build_model(self):
        ...
        dec_conv_1 = Conv1D(512, 5, strides=1, padding='same')(dec_emb)
        dec_activ_1 = Activation('relu')(dec_conv_1)
        dec_conv_2 = Conv1D(256, 5, strides=1, padding='same')(dec_activ_1)
        dec_activ_2 = Activation('relu')(dec_conv_2)
        dec_conv_3 = Conv1D(128, 5, strides=1, padding='same')(dec_activ_2)
        dec_activ_3 = Activation('relu')(dec_conv_3)
        dec_conv_4 = Conv1D(64, 3, strides=1, padding='same')(dec_activ_3)
        dec_activ_4 = Activation('relu')(dec_conv_4)
        dec_conv_5 = Conv1D(32, 3, strides=1, padding='same')(dec_activ_4)
        #dec_activ_5 = Activation('relu')(dec_conv_5)
        #dec_conv_6 = Conv1D(16, 3, strides=1, padding='same')(dec_activ_5)
        ...
        decoder_outputs = decoder_dense(dec_conv_5)
