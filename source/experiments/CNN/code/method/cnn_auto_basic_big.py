...
class CNN_Auto_Basic_Big:
    ...
    def build_model(self):
        ...
        decoder_cnn1 = Conv1DTranspose(16, kernel_size=3, padding='same', activation='relu')(encoder_cnn7)
        decoder_cnn2 = Conv1DTranspose(32, kernel_size=3, padding='same', activation='relu')(decoder_cnn1)
        decoder_cnn3 = Conv1DTranspose(64, kernel_size=3, padding='same', activation='relu')(decoder_cnn2)
        decoder_cnn4 = Conv1DTranspose(128, kernel_size=5, padding='same', activation='relu')(decoder_cnn3)
        decoder_cnn5 = Conv1DTranspose(256, kernel_size=5, padding='same', activation='relu')(decoder_cnn4)
        decoder_cnn6 = Conv1DTranspose(512, kernel_size=5, padding='same', activation='relu')(decoder_cnn5)
