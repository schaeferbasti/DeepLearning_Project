...
from tensorflow.keras.layers import Embedding, Conv1D, Concatenate, MaxPooling1D, Dense, Dropout, Flatten, Input, RepeatVector, Reshape
...
class CNN_Auto_Basic:
    ...
    def build_model(self):
        ...
        encoder_cnn1 = Conv1D(64, kernel_size=5, padding='same', activation='relu')(enc_emb)
        encoder_cnn2 = Conv1D(32, kernel_size=3, padding='same', activation='relu')(encoder_cnn1)
        encoder_pool = MaxPooling1D(pool_size=1, strides=1)(encoder_cnn2)
        ...
        encoder_output_repeated = RepeatVector(32)(Flatten()(encoder_pool))
        ...
        decoder_cnn3 = MaxPooling1D(pool_size=1, strides=1)(decoder_cnn2)
