...
class EncoderDecoderRNNModel:
    ...
    def build_model(self):
        ...
        encoder_rnn1 = SimpleRNN(64, return_sequences=True)(enc_emb)
        encoder_rnn2 = SimpleRNN(64, return_sequences=True)(encoder_rnn1)
        _, state = SimpleRNN(64, return_state=True)(encoder_rnn2)
        ...
        decoder_rnn1 = SimpleRNN(64, return_sequences=True, return_state=True)(dec_emb, initial_state=state)
        decoder_rnn2 = SimpleRNN(64, return_sequences=True)(decoder_rnn1[0])
