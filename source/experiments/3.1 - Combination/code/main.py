...
from source.experiments.Combination.code.method.RNN_Bi_CNN_SAN import RNN_Bi_CNN_SAN
...
if __name__ == '__main__':
    ...
    method_name = ['RNN_Bi_CNN_SAN']
    method_instance = [RNN_Bi_CNN_SAN(tokenizer_en, tokenizer_fr, max_len, MAX_VOCAB_SIZE_FR)]
    ...
    for i in range(len(method_name)):
        ...
        if train_model == True:
            ...
            if method_name[i] == 'RNN_Bi_CNN_SAN':
