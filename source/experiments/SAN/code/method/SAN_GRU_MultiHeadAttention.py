...
from tensorflow.keras.layers import Input, Embedding, GRU, Dense, MultiHeadAttention, Concatenate, Dropout

class SAN_GRU_MultiHeadAttention:
    ...
    def build_model(self):
        ...
        encoder_rnn1 = GRU(32, return_sequences=True)(encoder_embedding)
        encoder_dropout1 = Dropout(0.5)(encoder_rnn1)
        encoder_rnn2 = GRU(32, return_sequences=True)(encoder_dropout1)
        encoder_dropout2 = Dropout(0.5)(encoder_rnn2)
        encoder_rnn3 = GRU(32, return_sequences=True)(encoder_dropout2)
        ...
        decoder_inputs = Input(shape=(None,))
        decoder_embedding = Embedding(input_dim=len(self.tokenizer_fr.word_index) + 1, output_dim=64)(decoder_inputs)
        decoder_rnn1 = GRU(32, return_sequences=True)(decoder_embedding)
        decoder_dropout1 = Dropout(0.5)(decoder_rnn1)
        decoder_rnn2 = GRU(32, return_sequences=True)(decoder_dropout1)
        decoder_dropout2 = Dropout(0.5)(decoder_rnn2)
        decoder_rnn3 = GRU(32, return_sequences=True)(decoder_dropout2)
